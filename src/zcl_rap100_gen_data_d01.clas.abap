CLASS zcl_rap100_gen_data_d01 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_d01 IMPLEMENTATION.
...
*   clear data
    DELETE FROM zrap100_atravd01.
*    DELETE FROM zrap100_dtravd01.

    "insert travel demo data
    INSERT zrap100_atravd01  FROM (
        SELECT
